...
class Decoder(nn.Module):
    def __init__(self, latent_size, condition_size, hidden_size_1, hidden_size_2, sample_size):
        super().__init__()
...
class CVAE(nn.Module):
    def __init__(self, sample_size, condition_size, hidden_encoder_size, hidden_decoder_1_size, hidden_decoder_2_size, latent_size=2):
        super().__init__()
        ...
        self.decoder = Decoder(latent_size, condition_size, hidden_decoder_1_size, hidden_decoder_2_size, sample_size)
...
def main():
    ...
    model = CVAE(sample_size           = 10,
                 ...
                 hidden_decoder_1_size = 512,
                 hidden_decoder_2_size = 512,
                 latent_size           = 3)
    print(model)
